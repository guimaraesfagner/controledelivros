...
$_SG['tbl_usuario'] = 'usuarios';       // Nome da tabela onde os usuários são salvos
$_SG['tbl_pessoa'] = 'pessoa';      // Nome da tabela onde os dados pessoais dos usuarios estão salvos
...
//Validação do usuario propriamente dita
function validaUsuario($usuario, $senha) {
 ...
 // $sql = "SELECT `id`, `nome` FROM `".$_SG['tabela']."` WHERE ".$cS." `usuario` = '".$nusuario."' AND ".$cS." `senha` = '".$nsenha."' LIMIT 1";
   $sql = "SELECT ".$_SG['tbl_usuario'].".id, ".$_SG['tbl_pessoa'].".nome FROM ".$_SG['tbl_usuario']." INNER JOIN ".$_SG['tbl_pessoa']." ON ".$_SG['tbl_usuario'].".id_pessoa = ".$_SG['tbl_pessoa'].".id WHERE ".$cS." usuario = '".$nusuario."' AND ".$cS." senha = '".$nsenha."' LIMIT 1";
  echo $sql;
